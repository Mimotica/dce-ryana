...
# APP: reference = INVISIBLE (code VISIBLE)
df['app_visible'] = 0
df.loc[df['app'] == 'VISIBLE', 'app_visible'] = 1
df.loc[df['app'] == 'INVISIBLE', 'app_visible'] = -1

# Keep only model-ready columns
final_cols = base_cols + ['comfort_2.0', 'comfort_4.0', 'att_complete', 
                          'speech_moderate', 'speech_more_effort', 'app_visible']
