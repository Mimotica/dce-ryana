#!/usr/bin/env python3
"""
MNL model fitting script using pylogit.
...
def main():
    parser = argparse.ArgumentParser(description='Fit MNL model and calculate WTP')
    ...
    parser.add_argument('--coef_output', default='output/coefficients.csv',
                       help='Coefficients output file')
    parser.add_argument('--wtp_output', default='output/wtp_levels.csv',
                       help='WTP levels output file')
    parser.add_argument('--range_output', default='output/attribute_ranges.csv',
